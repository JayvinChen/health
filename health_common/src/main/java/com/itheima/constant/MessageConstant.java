...
public interface MessageConstant {
    ...
    static final String EDIT_PACKAGE_FAIL = "编辑套餐失败";
    static final String EDIT_PACKAGE_SUCCESS = "编辑套餐成功";
    ...
    static final String ORDERTYPE_TELEPHONE = "电话预约";
    static final String ORDERTYPE_WEIXIN = "微信预约";
    static final String ORDERSTATUS_YES = "已到诊";
    static final String ORDERSTATUS_NO = "未到诊";
}
